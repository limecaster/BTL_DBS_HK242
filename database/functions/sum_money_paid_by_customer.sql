...
SELECT dbo.GetTotalMoneyPaidByCustomer('0842000111', '2024-01-01', '2024-12-31') AS TotalPaid; -- user exist
SELECT dbo.GetTotalMoneyPaidByCustomer('0842000111', '2024-12-31', '2024-01-01') AS TotalPaid; -- invalid date range
SELECT dbo.GetTotalMoneyPaidByCustomer('0842000111', NULL, NULL) AS TotalPaid; -- no date range
